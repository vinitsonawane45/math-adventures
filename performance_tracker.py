...
#         recent_window: Number of recent questions to consider for rolling accuracy.
#         """
#         self.history = []  # full log of all attempts
#         self.recent = deque(maxlen=recent_window)  # rolling correctness for recent questions

#     def log(self, question, user_answer, correct_answer, time_taken, level, operation, confidence=None):
#         """
#         Log a single question attempt.

#         Parameters:
#         - question: str, the question asked
#         - user_answer: str/int/float, the user's answer
#         - correct_answer: str/int/float, the correct answer
#         - time_taken: float, time taken in seconds
#         - level: int, difficulty level of the question
#         - operation: str, operator used in the question
#         - confidence: optional float (0-1) representing confidence in the question
...
#         """Return the mean accuracy of recent questions (rolling window)."""
#         return np.mean(self.recent) if self.recent else 0.5

#     def get_weighted_accuracy(self):
#         """
#         Returns a confidence-weighted accuracy over all history.
#         Useful for adaptive engines.
#         """
#         if not self.history:
#             return 0.5
...
#         """
#         Returns a nested dict of accuracy by level and operation.
#         Example output: {level: {operation: accuracy}}
#         """
...
#     def summary(self):
#         """
#         Return a summary of the user's performance.
#         Includes total questions, correct, overall and recent accuracy, and average time.
#         """
...
#         Returns weighted overall accuracy (same as get_weighted_accuracy()).
#         """
#         return self.get_weighted_accuracy()
